The classes folder has a class defined that can be univeraslly used on any table in the database to retrive related information. This might not work on tables, user must 
